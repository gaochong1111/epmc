...
/**
 * Class collecting options used for our QMC LTL solver.
 * 
 * @author Ernst Moritz Hahn
 */
public enum OptionsLTLQMC {
    ...
    LTL_QMC_USE_BREAKPOINT,
    /** Whether the multi-breakpoint approach may be used . */
    LTL_QMC_USE_BREAKPOINT_SINGLETONS,
