...
import epmc.propertysolver.ltlqmc.automata.AutomatonDDBreakpoint;
import epmc.propertysolver.ltlqmc.automata.AutomatonDDSubset;
...
public final class PropertySolverDDLTLQMC implements PropertySolver {
    ...
    private DD checkTemporalLTLNonIncremental(Buechi buechi, StateSetDD forStates)
    {
        ...
        ensure(result != null, ProblemsLTLQMC.LTL_QMC_COULDNT_DECIDE);
        return result;
    }
    ...
    private DD checkTemporalLTLIncremental(Buechi buechi, StateSetDD forStates) {
        ...
        log.send(MessagesLTLQMC.LTL_QMC_EXPLORING_STATE_SPACE_DONE, modelStates, automatonStates);
    ...
    private DD decideComponents(ProductGraphDDDD product, ComponentsDD components, DD nodeSpace)
    {
        ...
        ensure(undecided.isFalse(), ProblemsLTLQMC.LTL_QMC_COULDNT_DECIDE);
        undecided.dispose();
            ...
            ProductGraphDDDD subsetProduct, DD component, boolean bscc)
    {
        ...
        log.send(MessagesLTLQMC.LTL_QMC_EXPLORING_STATE_SPACE_DONE, numStates, numAut);
    ...
    private DD computeNonIncremental(DecisionMethod method, Buechi buechi,
        ...
        log.send(MessagesLTLQMC.LTL_QMC_EXPLORING_STATE_SPACE_DONE, numModelStates, numAutomatonStates);
        ...
        todoNodes.dispose();
        sccs.close();
        log.send(MessagesLTLQMC.LTL_QMC_COMPUTING_END_COMPONENTS_DONE, numSCCs);
    ...
    public StateMap solve() {
        ...
        this.skipTransient = options.getBoolean(OptionsLTLQMC.LTL_QMC_SCC_SKIP_TRANSIENT);
